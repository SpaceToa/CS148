...
$tableName = "";
?>
<ul>    <li> q01: <a href="q01.php">SQL</a>  SELECT DISTINCT fldCourseName FROM tblCourses, tblEnrolls WHERE tblEnrolls.fldGrade = 100 AND pmkCourseId = fnkCourseId ORDER BY fldCourseName</li>
...
if (isset($_GET['getRecordsFor'])) {
    ...
    $columns = 1;
    $query = 'SELECT DISTINCT fldCourseName FROM tblCourses, tblEnrolls WHERE tblEnrolls.fldGrade = 100 AND pmkCourseId = fnkCourseId ORDER BY fldCourseName';
