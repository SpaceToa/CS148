...
print'<aside>';
    ...
    $columns = 10;
    $query = "SELECT `fldGameName`, `fldSystem`, `fldAccount`, `fldName`, `fldDescription`, `fldDate`, `fldTime`, `fldMeetUp`, `fldMic`, `fldType` FROM `tblEntries` WHERE fldSystem = 'PS3' ORDER BY pmkID DESC";
